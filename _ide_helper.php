...
')
     ...
     */ 
         ...
         *
         * @see \App\Providers\AppServiceProvider::boot()
         * @param \Closure|array|string $key
         * @param mixed|null $value
         * @return \Illuminate\Support\Collection 
         * @static 
         */ 
        public static function mergeIfMissing($key, $value = null)
        {
                        return \Illuminate\Support\Collection::mergeIfMissing($key, $value);
        }
                    /**
         * 
         *
...
namespace  { 
             ...
             * 
             *
             * @see \MPhpMaster\LaravelAppHelpers\Providers\HelperProvider::registerMacros()
             * @param array $attributes
             * @param array $values
             * @static 
             */ 
            public static function firstOrCreateOrRestore($attributes = [], $values = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::firstOrCreateOrRestore($attributes, $values);
            }
             ...
             * @static 
             */ 
            public static function getSql($parse = false)
            {
                                return \Illuminate\Database\Eloquent\Builder::getSql($parse);
            }
