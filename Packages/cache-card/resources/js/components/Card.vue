...
export default {
    ...
    methods: {
        onFlush() {
            Nova.request()
                .post('/nova-vendor/mphpmaster/cache-card/flush')
                .then(response => {
        ...
        onForget(cacheKey) {
            Nova.request()
                .post('/nova-vendor/mphpmaster/cache-card/cache', { cacheKey })
                .then(response => {
                if (!response.data.success) {
        ...
        onGet(cacheKey) {
            Nova.request()
                .get('/nova-vendor/mphpmaster/cache-card/cache?cacheKey=' + cacheKey)
                .then(response => {
                if (!response.data.success) {
