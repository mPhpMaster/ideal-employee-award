...
return [
    ...
    'roles' => [
        $superAdminRole,
        InConfigParser::roleOf(IRole::AdminRole),
        InConfigParser::roleOf(IRole::SupervisorRole, "user"),
        InConfigParser::roleOf(IRole::ForemanRole, "user"),
        InConfigParser::roleOf(IRole::EmployeeRole, "user"),

    ],

    'permissions' => [
        // ...InConfigParser::permissionsOf("credit_request.approver", "user"),

        // [ 'name' => 'user.index', 'group' => 'system', 'guard_name' => 'web' ],
        // [ 'name' => 'user.viewAny', 'group' => 'system', 'guard_name' => 'web' ],
        ...
        // [ 'name' => 'user.forceDelete', 'group' => 'system', 'guard_name' => 'web' ],
    ],
