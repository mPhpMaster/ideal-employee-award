...
trait THasScopeName
{
    ...
    {
        return $builder->whereIn('name', array_flatten(array_wrap(value($name))));
    }
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeWithoutName(Builder $builder, ...$name): Builder
    {
        return $builder->whereNotIn('name', array_flatten(array_wrap(value($name))));
    }
